...
def load_and_preprocess_data(uploaded_file):
    ...
    try:
        ...
        required_columns = ['household_income', 'got_helb', 'helb_amount', 
                          'scholarship_amount', 'program_cost_per_year', 
                          'financial_stress_level', 'likely_to_dropout']
        ...
        st.error(f"Error reading the file: {str(e)}. Please ensure it's a valid CSV file.")
        return None, None
...
def main():
    ...
    # Sidebar for navigation and file uploader
    ...
    # Load data
    data, le = load_and_preprocess_data(uploaded_file)
    if data is None:
        return
    ...
    st.markdown("---")
    st.markdown("Developed by xAI | Data Source: User-uploaded Kenyan Student Funding Dataset")
